    ...
    internal class Wall : GameItem
    {
        ...
        public override Geometry Area
        {
            get
            {
               ...
               // gg.Children.Add(new RectangleGeometry(new Rect(0, 0, displayWidth, 5)));//padló
                ...
                gg.Children.Add(new RectangleGeometry(new Rect(0, displayHeight - 5, displayWidth, 5))); //tető
                return gg;
            }
        }
    }
